...
interface IStakingAcceleration {
...
contract StakingRewardsAccelerator is ReentrancyGuard {
    IERC721 public NFT;
    IStakingAcceleration public acceleration;

    mapping(address => uint256) private _staked;

    constructor(
        address _NFT,
        address _stakingAcceleration
    ) public {
        NFT = IERC721(_NFT);
        acceleration = IStakingAcceleration(_stakingAcceleration);
    }
    ...
    function stake(uint256 tokenId) external nonReentrant {
        ...
        acceleration.setAcc(msg.sender, 2);
    ...
    function withdarw() external nonReentrant {
        ...
        acceleration.setAcc(msg.sender, 0);
        _withdraw(tokenId);
    }
